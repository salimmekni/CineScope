...
dependencies {
    // Firebase BOM (gestion automatique des versions)
    implementation(platform("com.google.firebase:firebase-bom:32.2.3"))
    implementation("com.google.android.material:material:1.10.0") // Assure-toi d'avoir cette ligne
    ...
    // Glide pour le chargement des images (mise à jour)
